      ...
      */
      ...
      $scope.rebuild = function () {
        ...
        elem.on('shown.bs.tooltip', function () {
          ...
          animation: false,
          template: $scope.isBS3 ? "<div class=\"tooltip ng-tooltip-".concat($scope.$id, "\" role=\"tooltip\"><div class=\"tooltip-arrow\"></div><div class=\"tooltip-inner\"></div></div>") : $scope.isBS4 ? "<div class=\"tooltip ng-tooltip-".concat($scope.$id, "\" role=\"tooltip\"><div class=\"arrow\"></div><div class=\"tooltip-inner\"></div></div>") : "<div class=\"tooltip ng-tooltip-".concat($scope.$id, "\" role=\"tooltip\"><div class=\"tooltip-arrow\"></div><div class=\"tooltip-inner\"></div></div>")
        }).addClass('ng-tooltip');
          ...
          elem.one('shown.bs.tooltip', function () {
            ...
            if ($scope.isBS3) {
              ...
              if ($scope.tooltipTether === true || isFinite($scope.tooltipTether)) {
                var lastPos;
                var lastVisible;
                $scope.tetherTimer = $interval(function () {
      ...
      $scope.$watchGroup(['tooltip', 'tooltipPosition', 'tooltipContainer', 'tooltipTrigger', 'tooltipHtml', 'tooltipShow', 'tooltipTether'], $scope.rebuild); // Respond to upstream events {{{
      ...
      $scope.$on('$destroy', function () {
        ...
        angular.element(".ng-tooltip-".concat($scope.$id)).remove();
